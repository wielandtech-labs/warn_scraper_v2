...
class ViewerSchemas:
    ...
    enterprise/admin sessions get the *EnterpriseOut subclasses (the provider fields
    including raw DUNS); paid sessions get *EnrichedOut (the provider fields minus DUNS);
