...
| paid  | + the provider fields on companies: duns, parent_duns, parent_company_name, global_ultimate_name, hq_address, employee_count |
...
the provider-sourced fields were deliberately excluded from the public API
