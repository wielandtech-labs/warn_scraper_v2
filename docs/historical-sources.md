...
- **2026-07-07 — IL PDF era 1999–2019 parser landed** (`parse_il_pdf`, PR #211
  ...
  **3,732**, verified per-record via the public API — pre-2000 = 149 = the 1999
  ...
  dedup (amended notices). Sole gap: **January 2019** is an image-only scan (no
  text layer) → tesseract-OCR follow-up (same path as NV 2021).
...
| IL | ~~2025~~ ~~2020~~ **1999 ✅** | `illinoisworknet.com/LayoffRecovery/` archive — monthly XLSX 2020+, monthly **PDFs 1999–2019** (a two-column labeled *form*, not a table — each flattened line split at its right-column label, x-independent) | **1999** (PDF era) | xlsx era **done 2026-06-12** (+861); **PDF era done 2026-07-07** (`parse_il_pdf` #211 + fix #217; Jobs w_homelab #635/#644/#645): **+2,707 rows, floor → 1999** (IL 1,017 → **3,732**, API-verified). near_miss=0. Jan 2019 image-only (OCR gap) |
