...
| IA | 2021 | Wayback rolling-log snapshots, union of 4 (`WARN_20150722.pdf`, `WARN_20171219.xlsx`, `WARN_20210105.xlsx`, `WARN_20230823.xlsx`) | **2005-07** | build pending (+600–800 after dedup); "Amendment" rows |
...
| WV | 2021 | Wayback cumulative `WV_WARN_Notices_3-1-11_to_6-7-21.pdf` (capture 1 MiB-truncated — PyMuPDF repairs all 137 pp) | **2011** | build pending (+~350) |
...
| IN | 2008 | Wayback DWD pages, 3 generations: `workforce_stats/warn/{2000..2003}.html`, rolling `notices.html` 2003–05, accumulating `employers/warn_notices.html` 2005–07 | **2000** | build pending (+450–530); gaps Nov–Dec 2004, Oct–Dec 2007 |
